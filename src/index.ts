import { makeRestApi, RestApiResponse, RestApiConfig } from 'rest-utils';
import qs from 'qs';
...
const _fetchData = <T>(url: string, fetchOptions?: RestApiConfig): RestApiResponse<T> => {
  return makeRestApi(url, fetchOptions || {});
};
